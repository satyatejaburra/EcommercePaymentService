package com.luv2code.ecommerce.payments.util;
...
public class PaymentUtil {
	...
	private static final String sUrl = "http://localhost:8081/payment/payment-response";

	private static final String fUrl = "http://localhost:8081/payment/payment-response";

	public static PaymentDetails populatePaymentDetail(PaymentDetails paymentDetail) {
		String hashString = "";
		...
		paymentDetail.setServiceProvider("payu_paisa");
	...
	public static String hashCal(String type, String str) {
		...
		try {
			...
			System.out.println("exception paymentutil");
		}
